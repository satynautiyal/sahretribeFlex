...
const LoginFormComponent = props => {
  const handleLogin = (email, password) => {
    ...
    // this.props.submitLogin(email, password).then(() => {
    //   const path = pathByRouteName('CategoriesPage', routeConfiguration());
    //   console.log(history, 'DDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD');
