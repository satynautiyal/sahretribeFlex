...
const OneTimePaymentWithCardElement = props => {
  ...
  //       }
  //       else {
  //         console.log("result not 122", result)
  //       }
  //     })
  //     .catch(err=>{
  //       console.log("err", err);
  ...
  return (
    <React.Fragment>
      <h3 className={css.info}>
        <FormattedMessage id="CheckoutPage.youWillOnlyBeChargedInfo" />
      </h3>
      ...
      {applePayEnabled ? (
        <Elements stripe={stripePromise}>
          // Display Apple Pay button if it's available
...
class StripePaymentForm extends Component {
  ...
  checkApplePayAvailability() {
    ...
    console.log("THis is for testing",paymentRequest)
  }
          ...
          <React.Fragment>
            {showPaymentMethodSelector ? (
              <PaymentMethodSelector
                ...
                intl={intl}
                applePayEnabled={this.state.applePayEnabled}
