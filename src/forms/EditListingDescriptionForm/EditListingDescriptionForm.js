...
const EditListingDescriptionFormComponent = props => (
  <FinalForm
    ...
    render={formRenderProps => {
      ...
      const newQuestion = intl.formatMessage({
        id: 'EditListingDescriptionForm.description',
      });
      ...
      const usCitizenLabel = intl.formatMessage({
        id: 'EditListingDescriptionForm.usCitizenLabel',
      });
      ...
      const allowedToWorkLabel = intl.formatMessage({
        id: 'EditListingDescriptionForm.allowedToWorkLabel',
      });
      ...
      return (
        <Form className={classes} onSubmit={handleSubmit}>
          ...
          <div className={css.usCitizenContainer}>
            ...
            />
            <FieldCheckbox
              id="activity-leadership-coaching"
              name="activity"
              className={css.consentStripeAgreement}
            ...
            />
            <FieldCheckbox
              id="activity-professional-skills"
              name="activity"
              className={css.consentStripeAgreement}
