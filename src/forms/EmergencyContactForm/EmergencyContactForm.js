...
import css from './EmergencyContactForm.module.css';
import getCountryCodes from '../../translations/countryCodes';
import config from '../../config';

const SHOW_EMAIL_SENT_TIMEOUT = 2000;

class EmergencyContactFormComponent extends Component {
  constructor(props) {
    super(props);
    ...
    return (
      <FinalForm
        ...
        render={fieldRenderProps => {
          ...
          const { emergencyContactName, emergencyPhoneNumber, emergencycountrycode } = values;
          ...
          const nameRequired = validators.required(emailRequiredMessage);
          ...
          const nameChanged = currentemergencyContactName !== emergencyContactName;

          const namePlaceholder = intl.formatMessage({
            id: 'Enter emergency contact name',
          });
          const countrycodePlaceholder = intl.formatMessage({
            id: 'Enter country code',
          });
          const nameLabel = intl.formatMessage({ id: 'Full Name' });
          ...
          const phoneNumberChanged = currentEmergencyPhoneNumber !== emergencyPhoneNumber;

          const phonePlaceholder = intl.formatMessage({
            id: 'Enter emergency phone number',
          });
          ...
          if (saveNameError) {
            genericError = (
              <span className={css.error}>
                <FormattedMessage id="ContactDetailsForm.NameEror" />
              </span>
            );
          }
          ...
          const submitDisabled =
            ...
            inProgress ||
            !(nameChanged || phoneNumberChanged);
          ...
          return (
            ...
            >
              ...
              <div className={css.confirmClasses}></div>
...
EmergencyContactFormComponent.defaultProps = {
  rootClassName: null,
  className: null,
  formId: null,
  saveNameError: null,
...
EmergencyContactFormComponent.propTypes = {
  rootClassName: string,
  className: string,
  formId: string,
  saveNameError: propTypes.error,
...
const EmergencyContactForm = compose(injectIntl)(EmergencyContactFormComponent);
