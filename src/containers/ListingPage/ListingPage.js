...
export class ListingPageComponent extends Component {
  ...
  render() {
    ...
    const address2 = location2 ? location2.address : '';
    const address3 = location3 ? location3.address : '';

    const location2Title = <FormattedMessage id="ListingPage.location2Title" />;
    const location3Title = <FormattedMessage id="ListingPage.location3Title" />;
    return (
      <Page
        title={schemaTitle}
            ...
            <div>
              ...
              <div className={css.contentContainer}>
                ...
                <div className={css.mainContent}>
                  ...
                  />
                  <SectionCustomFieldsMaybe listing={currentListing} />
                  {/* <SectionFeaturesMaybe options={specializationsOptions} publicData={publicData} /> */}
                  ...
                  {/*    geolocation={geolocation}*/}
                  {/*    address={address2}*/}
                  {/*    locationTitle={location2Title}*/}
                  {/*    listingId={currentListing.id}*/}
                  {/*    className={css.location2map}*/}
                  {/*  /> : null*/}
                  {/*}*/}
                  ...
                  {/*    geolocation={geolocation}*/}
                  {/*    address={address3}*/}
                  {/*    locationTitle={location3Title}*/}
                  {/*    listingId={currentListing.id}*/}
                  {/*    className={css.location3map}*/}
                  {/*  /> : null*/}
                  {/*}*/}
