...
import css from './HelpClientPage.module.css';

const HelpClientPageComponent = props => {
  ...
  return (
    <Page title={schemaTitle} scrollingDisabled={scrollingDisabled} schema={schema}>
      <LayoutSideNavigation>
        <LayoutWrapperTopbar>
          <TopbarContainer currentPage="HelpClientPage" />
        </LayoutWrapperTopbar>
        <LayoutWrapperSideNav tabs={tabs} />
        <LayoutWrapperMain>
          <div className={css.content}>
            <h1 className={css.heading}>
              <FormattedMessage id="HelpGeneralPage.clientTab" />
            </h1>
            <HelpClientQs />
          </div>
        </LayoutWrapperMain>
...
HelpClientPageComponent.propTypes = {
...
const HelpClientPage = compose(connect(mapStateToProps), injectIntl)(HelpClientPageComponent);
