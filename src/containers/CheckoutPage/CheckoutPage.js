...
// import * as int from 'sharetribe-flex-integration-sdk';
...
export class CheckoutPageComponent extends Component {
  ...
  loadInitialData() {
    ...
    if (shouldFetchSpeculatedTransaction) {
      ...
      const { location_address } = bookingData;
  ...
  handleSubmit(values) {
    ...
    this.handlePaymentIntent(requestPaymentParams)
      .then(res => {
        ...
        updateLocation({
          location: this.state.pageData.bookingData?.location,
          location_address: this.state.pageData.bookingData?.location_address,
          orderId: orderId,
        });

        // const integrationSdk = createInstance({
        //   clientId: '5408e5e5-6837-4a77-bbfe-3a9eb19aec2e',
        //   clientSecret: 'eaa18ab2480196251b57a697a73abe104f72090d',
        // });
        ...
        //       metadata: {
        //         category:
        //           this.state.pageData?.listing?.attributes?.publicData?.category[0] ||
        //           this.state.pageData?.listing?.attributes?.publicData?.category ||
        //           '',
        //         location: this.state.pageData.bookingData?.location,
        //         location_address: this.state.pageData.bookingData?.location_address,
        //       },
