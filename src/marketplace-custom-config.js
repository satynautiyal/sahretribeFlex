...
export const filters = [
  ...
  //     options: [
  //       { key: 'leadership', label: 'Leadership' },
  //       { key: 'academics', label: 'Professional skills' },
  //       { key: 'creative', label: 'Creative' },
  ...
  //       { key: 'central singapore', label: 'Central Singapore' },
  ...
  {
    id: 'ageCategory',
    label: 'Age Specialisation',
    type: 'SelectMultipleFilter',
    group: 'primary',
    queryParamNames: ['pub_ageCategory'],
    config: {
      searchMode: 'has_any',
      options: [
        { key: 'senior', label: 'Senior (55+ years)' },
        { key: 'adult', label: 'Adult (19 - 54 years)' },
        { key: 'teen', label: 'Teen (13 - 18 years)' },
        { key: 'child', label: 'Kids (6 - 12 years)' },
      ],
    },
  },
  // {
  //   id: 'virtualTraining',
  //   label: 'Virtual or Personal Trainer',
  //   type: 'SelectSingleFilter',
  //   group: 'primary',
  //   queryParamNames: ['pub_virtualTraining'],
  //   config: {
  //     options: [
  //       { key: 'yes', label: 'Virtual' },
  //       { key: 'yes,no', label: 'Personal' },
  //     ],
  //   },
  // },
  // {
  ...
  //   type: 'SelectMultipleFilter',
  //   group: 'secondary',
  //   queryParamNames: ['pub_specializations'],
  //   config: {
