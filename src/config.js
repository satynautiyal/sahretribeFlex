...
const addressCountry = 'Singapore';
...
const siteTitle = 'ProLed';

// Twitter handle is needed in meta tags (twitter:site). Start it with '@' character
const siteTwitterHandle = '@oneprolead';

// Instagram page is used in SEO schema (http://schema.org/Organization)
const siteInstagramPage = 'https://www.instagram.com/proled.app/';

// Facebook page is used in SEO schema (http://schema.org/Organization)
const siteFacebookPage = 'https://www.facebook.com/profile.php?id=100095187533152';
...
const clientIntegrationId = process.env.INTEGRATION_ID;
const clientIntegrationSecret = process.env.S_INTEGRATION_ID;
