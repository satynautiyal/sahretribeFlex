...
const EditListingAvailabilityPanel = props => {
  ...
  const footnote = <FormattedMessage id="EditListingAvailabilityPanel.footnote" />;
  ...
  return (
    <main className={classes}>
      ...
      <section className={css.section}>
        <header className={css.sectionHeader}>
          ...
          <p className={css.sectionSubTitle}>
            <FormattedMessage id="EditListingAvailabilityPanel.defaultScheduleSubtitle" />
          </p>
        </header>
      ...
      <section className={css.section}>
        ...
        <p className={css.sectionSubTitle}>
          <FormattedMessage id="EditListingAvailabilityPanel.exceptionSubtitle" />
        </p>
        {fetchExceptionsInProgress ? (
