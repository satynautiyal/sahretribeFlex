...
import {
  ...
  EditListingPersonalDetailsPanel,
  // EditListingFeaturesPanel,
  EditListingBackgroundAndExperiencePanel,
  // EditListingTrainingPreferencesPanel,
  // EditListingSubmitApplicationPanel,
  // EditListingLocationPanel,
  EditListingPhotosPanel,
  // EditListingPoliciesPanel,
  EditListingPricingPanel,
  // EditListingIdentityVerificationPanel,
  EditListingReviewAndSubmitPanel,
} from '../../components';

import css from './EditListingWizard.module.css';

export const AVAILABILITY = 'availability';
export const DESCRIPTION = 'personalDetails';
export const FEATURES = 'features';
export const BACKGROUND_AND_EXPERIENCE = 'backgroundAndExperience';
export const TRAINING_PREFERENCES = 'trainingPreferences';
export const SUBMIT_APPLICATION = 'submitApplication';
export const POLICY = 'policy';
export const LOCATION = 'location';
export const PRICING = 'pricing';
export const PHOTOS = 'photos';
// export const IDENTITY_VERIFICATION = 'identityVerification';
  ...
  switch (tab) {
    case DESCRIPTION: {
      const submitButtonTranslationKey = isNewListingFlow
        ? 'EditListingWizard.savePersonalDetails'
    ...
    //   );
    // }
    case BACKGROUND_AND_EXPERIENCE: {
      const submitButtonTranslationKey = isNewListingFlow
        ? 'EditListingWizard.saveNewBackgroundAndExperience'
        : 'EditListingWizard.saveEditBackgroundAndExperience';
      return (
        <EditListingBackgroundAndExperiencePanel
          {...panelProps(BACKGROUND_AND_EXPERIENCE)}
          submitButtonText={intl.formatMessage({ id: submitButtonTranslationKey })}
          onSubmit={values => {
            onCompleteEditListingWizardTab(tab, values);
          }}
    ...
    //   const submitButtonTranslationKey = isNewListingFlow
    //     ? 'EditListingWizard.saveNewTrainingPreferences'
    //     : 'EditListingWizard.saveEditTrainingPreferences';
    //   return (
    //     <EditListingTrainingPreferencesPanel
    //       {...panelProps(TRAINING_PREFERENCES)}
    //       submitButtonText={intl.formatMessage({ id: submitButtonTranslationKey })}
    //       onSubmit={values => {
    //         onCompleteEditListingWizardTab(tab, values);
    //       }}
    ...
    //   const submitButtonTranslationKey = isNewListingFlow
    //     ? 'EditListingWizard.saveNewIdentityVerification'
    //     : 'EditListingWizard.saveEditIdentityVerification';

    //   return (
    //     <EditListingIdentityVerificationPanel
    //       {...panelProps(IDENTITY_VERIFICATION)}
    //       submitButtonText={intl.formatMessage({ id: submitButtonTranslationKey })}
    //       onSubmit={values => {
    //         onCompleteEditListingWizardTab(tab, values);
    //       }}
    ...
    //   const submitButtonTranslationKey = isNewListingFlow
    //     ? 'EditListingWizard.saveNewSubmitApplication'
    //     : 'EditListingWizard.saveEditSubmitApplication';
    //   return (
    //     <EditListingSubmitApplicationPanel
    //       {...panelProps(SUBMIT_APPLICATION)}
    //       submitButtonText={intl.formatMessage({ id: submitButtonTranslationKey })}
    //       onSubmit={values => {
    //         onCompleteEditListingWizardTab(tab, values);
    //       }}
    ...
    case REVIEW_AND_SUBMIT: {
      const submitButtonTranslationKey = 'Submit';
      return (
        <EditListingReviewAndSubmitPanel
          {...panelProps(SUBMIT_APPLICATION)}
          submitButtonText={intl.formatMessage({ id: submitButtonTranslationKey })}
